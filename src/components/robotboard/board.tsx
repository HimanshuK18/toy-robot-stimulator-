    ...
    <div className="container">
      ...
      <div className="column">
        ...
        <span className="status-text">
          X:<span data-testid="status-x"
             className="status-text-value">
              {currentPosition.XPosition === -1 ? '' : currentPosition.XPosition}</span>,

          Y:<span data-testid="status-y"
          className="status-text-value">
            {currentPosition.YPosition === -1 ? '' : currentPosition.YPosition}</span>
        </span>
